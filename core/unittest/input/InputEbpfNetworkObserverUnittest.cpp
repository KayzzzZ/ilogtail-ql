...
void InputEbpfNetworkObserverUnittest::OnSuccessfulInit() {
    ...
    APSARA_TEST_EQUAL(ObserverType::SOCKET, input->mObserverOption.mObserver->mType);
    ObserverSocket* thisObserver = dynamic_cast<ObserverSocket*>(input->mObserverOption.mObserver);
